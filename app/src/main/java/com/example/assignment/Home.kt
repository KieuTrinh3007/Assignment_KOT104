...
data class Product(val id: Int, val name: String, @DrawableRes val imageResource: Int, val price: String)
...
fun BestSellerSection() {
    val productList = listOf(
        Product(1,"Black Simple Lamp", R.drawable.sp1, "$ 12.00"),
        Product(2,"Minimal Stand", R.drawable.sp2, "$ 25.00"),
        Product(3,"Coffee Chair", R.drawable.sp3, "$ 20.00"),
        Product(4,"Simple Desk", R.drawable.sp4, "$ 50.00"),
        Product(5,"Coffee Table", R.drawable.sp3, "$ 50.00"),
        Product(6,"Black Simple Lamp", R.drawable.sp1, "$ 12.00"),
    ...
    // Chuyển hướng khi có sản phẩm được chọn
